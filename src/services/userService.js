...
const createNew = async (reqBody) => {
  try {
    ...
    const verificationLink = env.BUILD_MODE === 'production' ? `https://trello-web-khaki.vercel.app/account/verification?email=${getNewUser.email}&token=${getNewUser.verifyToken}`
